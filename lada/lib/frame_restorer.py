...
class FrameRestorer:
    def __init__(self, device, video_file, max_clip_length, mosaic_restoration_model_name,
                 ...
                 mosaic_detection_batch_size: int | None = None,
                 detector_queue_maxsize: int | None = None):
        self.device = device
        ...
        self.mosaic_detector = MosaicDetector(self.mosaic_detection_model, self.video_meta_data.video_file,
                                              ...
                                              batch_size=mosaic_detection_batch_size or 4,
                                              queue_maxsize=detector_queue_maxsize or 8)
